        ...
        <>
            ...
            <div className=" custom-shape-divider-top-1723480175 relative">
                ...
                <div className='  flex flex-col justify-center align-middle items-center'>
                    <div
                        className="absolute right-0 bottom-8 px-[104px] pt-10 flex flex-row justify-between align-center gap-48 z-10"
                  ...
                  Your Path
                            ...
                            <p className="text-sm z-10 mt-4 sm:text-base text-gray-700 dark:text-white text-font">
                                Discover personalized learning experiences that empower you to achieve your goals, one
                                course at a time.
                            </p>
                        </div>
                        <div className="pb-10">
                    ...
                    <div
                        className="w-[84%] flex flex-col gap-5 z-10 absolute right-0 top-[-140px] h-36 rounded-xl bg-white mx-[110px] mt-40 shadow-custom-heavy"
                        style={{transform: 'rotate(-180deg)'}}>
                        <div>
